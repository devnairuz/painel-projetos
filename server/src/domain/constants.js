// Templates de Produto e defaults — espelham o frontend (src/constants).
...
const DEFAULT_SUPPORT_HOURS = { antes: 5, depois: 20 };

const DEFAULT_FINALIZATION = {
  mensagem:
...
module.exports = { PRODUCT_TEMPLATES, DEFAULT_SUPPORT_HOURS, DEFAULT_FINALIZATION };
